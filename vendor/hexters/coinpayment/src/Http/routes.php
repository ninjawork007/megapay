...
Route::group(['middleware' => ['web', Hexters\CoinPayment\Http\Middleware\listenConfigFileMiddleware::class], 'prefix' => 'coinpayment', 'namespace' => 'Hexters\CoinPayment\Http\Controllers'],
    function ()
    {
        Route::get('/', function ()
        {
...
Route::group(['namespace' => 'Hexters\CoinPayment\Http\Controllers'], function ()
{
