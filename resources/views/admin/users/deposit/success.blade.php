                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="text-center">
                                 ...
                                 <div class="text-center"><p><strong> Deposit Completed Successfully</strong></p></div>
                                <h5 class="text-center mt10">Deposit Amount : {{ moneyFormat($transaction->currency->symbol, formatNumber($transaction->subtotal)) }}</h5>
                    ...
                    <div class="col-md-7">
                        <div style="margin-left: 0 auto">
                            <div style="float: left;">
                                  <a href="{{url("admin/users/deposit/print/$transaction->id")}}" target="_blank" class="btn button-secondary"><strong>Print</strong></a>
                            </div>
